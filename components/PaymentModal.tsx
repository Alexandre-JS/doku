            ...
            {step === "success" && (
              ...
              >
                ...
                {/* <div className="mt-8 w-full space-y-5">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <button 
                        ...
                        className="flex items-center justify-center gap-2 rounded-2xl bg-blue-600 py-3.5 font-bold text-white shadow-lg shadow-blue-100 transition-all hover:bg-blue-700 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        {isSendingEmail ? (
                      ...
                      <button 
                        ...
                        className="flex items-center justify-center gap-2 rounded-2xl bg-[#25D366] py-3.5 font-bold text-white shadow-lg shadow-emerald-100 transition-all hover:bg-[#20bd5a] active:scale-95"
                      >
                    ...
                    <div className="mt-4 rounded-2xl bg-blue-50 p-3 text-left ring-1 ring-blue-100 sm:p-4">
                  ...
                  <button 
                    onClick={onClose}
                    className="mt-6 text-sm font-bold text-slate-400 hover:text-slate-900 transition-colors flex items-center gap-2 mx-auto"
                  >
